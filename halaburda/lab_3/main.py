...
def main():
    ...
    for port_data in data["ports"]:
        ...
        for j in range(0, len(ships)):
            ...
            ships_list.append(create_ship(ship_type, ship_id, port, port_deliver_id, configs, fuel))
        ...
        for count in range(0, basic):
            ...
            item_builder = ItemBuilder().weight.count(2).containerID(int(real_basic.id))
        ...
        for count in range(0, heavy):
            ...
            item_builder = ItemBuilder().weight.count(2).containerID(int(real_heavy.id))
        ...
        for count in range(0, refrigerated):
            ...
            item_builder = ItemBuilder().weight.count(3).containerID(int(real_refrigerated.id))
        ...
        for count in range(0, liquid):
            ...
            item_builder = ItemBuilder().weight.count(4).containerID(int(real_liquid.id))
    ...
    for ship_instance in ships_list:
        ...
        cont_count = len(port_deliver.basic) + len(port_deliver.heavy) + len(port_deliver.liquid) + len(
            port_deliver.refrigerated)
