...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Олег\Desktop\Потрібне шось\Patterns\Lab_5'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Олег\Desktop\Потрібне шось\Patterns\Lab_5\Scripts\deactivate.nu'
